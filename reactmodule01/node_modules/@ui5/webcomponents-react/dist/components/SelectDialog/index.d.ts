...
import { ListGrowingMode, ListMode } from '../../enums';
import { Ui5CustomEvent } from '../../interfaces/Ui5CustomEvent';
import { DialogDomRef, DialogPropTypes, ListPropTypes } from '../../webComponents';
export interface SelectDialogPropTypes extends Omit<DialogPropTypes, 'header' | 'headerText' | 'footer' | 'children'> {
     ...
     */
    onClear?: (event: Ui5CustomEvent<{
        prevSelectedItems: HTMLElement[];
    }>) => void;
    /**
     ...
     */
    onConfirm?: (event: Ui5CustomEvent<{
