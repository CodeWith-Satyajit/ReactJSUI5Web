...
import { MessageBoxActions, MessageBoxTypes } from '../../enums';
import { Ui5CustomEvent } from '../../interfaces/Ui5CustomEvent';
import { DialogDomRef, DialogPropTypes } from '../../webComponents';
declare type MessageBoxAction = MessageBoxActions | keyof typeof MessageBoxActions | string;
export interface MessageBoxPropTypes extends Omit<DialogPropTypes, 'children' | 'footer' | 'headerText' | 'onAfterClose' | 'state'> {
    /**
