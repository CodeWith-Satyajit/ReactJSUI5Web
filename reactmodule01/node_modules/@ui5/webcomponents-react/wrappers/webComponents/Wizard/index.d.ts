...
export interface WizardPropTypes extends WizardAttributes, CommonProps {
     ...
     */
    onStepChange?: (event: Ui5CustomEvent<WizardDomRef, {
        step: HTMLElement;
 ...
 */
declare const Wizard: import("react").ForwardRefExoticComponent<WizardPropTypes & import("../../internal/withWebComponent").WithWebComponentPropTypes & import("react").RefAttributes<WizardDomRef>>;
export { Wizard };
